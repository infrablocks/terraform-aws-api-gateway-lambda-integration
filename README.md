...
[![CircleCI](https://circleci.com/gh/infrablocks/terraform-aws-api-gateway-lambda-integration.svg?style=svg)](https://circleci.com/gh/infrablocks/terraform-aws-api-gateway-lambda-integration)

A Terraform module for integrating a lambda to an existing API gateway in AWS.
...
| api_gateway_rest_api_id               | API gateway REST API ID for which to create the integration                |    -    |   yes    |
| api_gateway_rest_api_root_resource_id | API gateway REST API root resource ID                                      |    -    |   yes    |
